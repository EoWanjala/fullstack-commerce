...
const FeaturedProducts = ({ product }) => {
    ...
    console.log("Products featured: ", product)
    const fullImageUrl = API_URL + product.thumbnail
  return (
    <div className='mx-3 md:mx-0 mt-10'>
        <Link className='flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow overflow-hidden'>
            <img src={fullImageUrl} className='w-full h-48'/>
            <div className='p-4'>
                <div className='text-center'>
                    ...
                    <div className='flex items-center justify-between mx-3 mt-1'>
